...
export default function DashboardMockup({
  ...
  return (
    <>
      ...
      {/* overflow-hidden actúa como red de seguridad: el tilt 3D (rotateY/rotateX)
          no afecta el layout, así que sin esto podría pintar por fuera de su caja
          y superponerse al contenido de la siguiente sección. El padding vertical
          le da al teléfono su propio espacio y absorbe ese sangrado del tilt. */}
